...
const PRESET_DEF = [
{ code: "TES", name: "Saint Testudera", skill: 87, style: "tikitaka", formation: "4-3-3", strategy: { approachPlay: -1, passingDir: -2, chanceCreation: -1, dribbling: -1, creativity: 1, timeWasting: -1, possLost: 1, possWon: -1, gkDist: -1, pressingLOE: 2, defLine: 2, dlBehavior: 2, tackling: -1 }, squad: buildSquad("4-3-3", ["X. Cienfuegos", "V. Peixoto", "I. Urrutia", "O. Montagut", "R. Alvarenga", "G. Valbuena", "Y. Bengoetxea", "T. Candeias", "P. Puigcorbé", "M. Salcedo", "B. Figueira", "U. Izagirre", "D. Quintana", "J. Xirau", "L. Escudero", "N. Gouveia"]) },
{ code: "NCH", name: "Nichirin", skill: 86, style: "wingplay", formation: "4-4-2", strategy: { passingDir: -1, chanceCreation: -1, dribbling: 1, creativity: 1, possLost: -1, possWon: 1, gkDist: -1, pressingLOE: 1, dlBehavior: -1, tackling: -1 }, squad: buildSquad("4-4-2", ["K. Ouyang", "S. Segawa", "D. Takanashi", "G. Fija", "A. Nagumo", "T. Bashira", "T. Mikado", "M. Kishima", "L. Higashiyama", "G. Erdene", "S. Itoshi", "E. Sato", "G. Nishigawa", "K. Torigoe", "W. Kon", "H. Morimoto"]) },
{ code: "ALE", name: "Alemannia", skill: 86, style: "tikitaka", formation: "4-2-3-1", strategy: { approachPlay: 1, passingDir: 1, chanceCreation: 1, dribbling: 1, creativity: -1, timeWasting: -1, possLost: 1, possWon: 1, gkDist: 1, pressingLOE: 2, defLine: 1, dlBehavior: 1, tackling: 1 }, squad: buildSquad("4-2-3-1", ["K. Bernhard", "F. Gruber", "V. Novotný", "J. Van Antwerp", "J. Dvořák", "T. Svoboda", "G. Dreesens", "O. Černý", "S. Boelens", "P. Procházka", "F. Van Can", "M. Noack", "R. Pietach", "S. Reier", "E. Lehner", "D. Kunze"]) },
{ code: "VIC", name: "Vicily", skill: 85, style: "counterattack", formation: "5-3-2", strategy: { approachPlay: -1, passingDir: -1, chanceCreation: -1, dribbling: -1, creativity: -1, timeWasting: 1, possLost: -1, possWon: -1, gkDist: -1, tackling: -1 }, squad: buildSquad("5-3-2", ["M. Rossi", "L. Squillaci", "A. Ferrari", "F. Castiglione", "G. Russo", "D. Vivaldi", "E. Bianchi", "V. Zaccagni", "S. Romano", "R. Lucchese", "C. Colombo", "P. Borromeo", "T. Ricci", "N. Donizetti", "I. Esposito", "U. Bellarmino"]) },
{ code: "ESU", name: "E.S.U.", skill: 85, style: "gegenpress", formation: "3-4-3", strategy: { approachPlay: -1, dribbling: 1, timeWasting: -1, possLost: 1, possWon: 1, gkDist: -1, pressingLOE: 1, defLine: 1, dlBehavior: 1 }, squad: buildSquad("3-4-3", ["S. Jackson", "N. Vitale", "M. Smith", "E. Farnsworth", "C. Bauer", "V. Moretti", "R. De Luca", "A. Anderson", "T. Hawthorne", "D. Rossi", "L. Vogel", "P. Turner", "P. Klein", "F. Hoffman", "W. Bradford", "S. Caruso"]) },
{ code: "ELV", name: "Elvester", skill: 85, style: "wingplay", formation: "4-2-3-1", strategy: { passingDir: -1, chanceCreation: -1, dribbling: 1, creativity: -1, setPieces: 1, possLost: -1, possWon: -1, gkDist: -1, pressingLOE: -1, dlBehavior: -1, tackling: -1 }, squad: buildSquad("4-2-3-1", ["J. Taylor", "O. Ashworth", "H. Brown", "W. Wetherby", "C. Davies", "T. Hargreaves", "G. Smith", "A. Whitmore", "M. Wright", "L. Bardsley", "E. Clark", "R. Townsend", "N. Hughes", "S. Chadwick", "D. Evans", "F. Lancaster"]) },
{ code: "ARV", name: "Arverne", skill: 84, style: "balanced", formation: "4-2-3-1", strategy: { approachPlay: 1, passingDir: 1, dribbling: 1, creativity: 1, possLost: -1, possWon: 1, pressingLOE: -1, dlBehavior: -1 }, squad: buildSquad("4-2-3-1", ["F. Beaulieu", "E. Delacroix", "L. Bernard", "M. Vasseur", "H. Dubois", "G. Chardon", "O. Desjardins", "C. Lemaitre", "T. Durand", "A. Blanc", "R. Gauthier", "M. Martin", "N. Richard", "V. Tardieu", "B. Roux", "P. Petit"]) },
{ code: "KAR", name: "Karjania", skill: 81, style: "wingplay", formation: "4-3-3", strategy: { approachPlay: -1, passingDir: 1, chanceCreation: -1, dribbling: 1, creativity: 1, setPieces: 1, timeWasting: -1, possLost: -1, possWon: 1, gkDist: 1, pressingLOE: 1, defLine: -1, dlBehavior: -1, tackling: 1 }, squad: buildSquad("4-3-3", ["A. Väisänen", "S. Helkanen", "K. Yrjölä", "E. Uusitalo", "P. Seppälä", "K. Kaljurand", "J. Soosaar", "O. Rástoš", "M. Heikinnen", "R. Duoŋgi", "V. Petrovic", "J. Hämäläinen", "O. Niskanen", "T. Saarela", "H. Karlsson", "T. Puusepp"]) },
{ code: "HOL", name: "Hollosend", skill: 81, style: "counterattack", formation: "4-2-3-1", strategy: { approachPlay: 1, passingDir: 1, dribbling: 1, creativity: 1, timeWasting: -1, possWon: 1, gkDist: 1, pressingLOE: 1 }, squad: buildSquad("4-2-3-1", ["C. Calhoun", "L. Urdaneta", "T. Uzcátegui", "W. Boone", "E. Escalona", "D. Landry", "M. Betancourt", "H. Hollis", "V. Vivas", "B. Covington", "S. Arismendi", "R. Vance", "G. Quintero", "A. Pickett", "J. Beauregard", "F. Machado"]) },
{ code: "ANA", name: "Anahuac", skill: 81, style: "tikitaka", formation: "4-3-3", strategy: { passingDir: -1, chanceCreation: -1, dribbling: -1, creativity: 1, setPieces: 1, possLost: 1, possWon: -1, gkDist: -1, pressingLOE: 1, defLine: 1, dlBehavior: 1, tackling: -1 }, squad: buildSquad("4-3-3", ["R. Rosario", "J. Salamanca", "C. Montoya", "E. Arenas", "J. Vera", "E. Luna", "L. Rivas", "Á. Fernandez", "R. Zapatero", "A. Villa", "S. Guzmán", "C. Acosta", "J. Valencia", "O. Pérez", "O. Vico", "A. Garza"]) },
{ code: "SKJ", name: "Skjarnland", skill: 77, style: "balanced", formation: "4-4-2", strategy: { approachPlay: 1, chanceCreation: -1, dribbling: 1, setPieces: 1, timeWasting: -1, possWon: 1, gkDist: 1, pressingLOE: 1 }, squad: buildSquad("4-4-2", ["M. Andersson", "K. Haugland", "E. Hansen", "O. Sjöberg", "L. Johansson", "V. Tvedt", "J. Olsen", "A. Lundqvist", "S. Karlsson", "H. Solberg", "P. Larsen", "N. Nyquist", "B. Eriksson", "T. Kvamme", "R. Pedersen", "F. Wallin"]) },
{ code: "GEN", name: "Genosa", skill: 77, style: "counterattack", formation: "4-1-2-1-2", strategy: { approachPlay: -1, passingDir: -1, chanceCreation: -1, creativity: 1, timeWasting: -1, possLost: -1, possWon: 1, gkDist: -1, tackling: -1 }, squad: buildSquad("4-1-2-1-2", ["M. Nagy", "Z. Váradi", "L. Kovács", "B. Zsolnay", "G. Tóth", "A. Hegedűs", "P. Szabó", "I. Kárpáti", "D. Varga", "F. Csikós", "V. Szilágyi", "K. Bátori", "J. Németh", "T. Almási", "R. Farkas", "S. Kiss"]) },
{ code: "RUD", name: "Rudania", skill: 76, style: "counterattack", formation: "5-3-2", strategy: { approachPlay: 1, passingDir: 1, creativity: -1, setPieces: 1, possLost: -1, possWon: 1, gkDist: 1, defLine: -1, dlBehavior: -1, tackling: 1 }, squad: buildSquad("5-3-2", ["I. Ivanov", "V. Krestovsky", "S. Smirnov", "T. Oorzhak", "A. Razumovsky", "M. Popov", "K. Zvezdinsky", "N. Ayusheev", "D. Kuznetsov", "E. Pobedonostsev", "P. Sokolov", "R. Safin", "F. Chistyakov", "I. Novikov", "L. Vronsky", "O. Yudin"]) },
{ code: "NKI", name: "Kinshū", skill: 76, style: "gegenpress", formation: "4-1-4-1", strategy: { approachPlay: 1, passingDir: 1, dribbling: 1, creativity: 1, setPieces: 1, possLost: -1, dlBehavior: -1 }, squad: buildSquad("4-1-4-1", ["D. Dhamarrandji", "K. Ikeda", "G. Munyarryun", "A. Gurruwiwi", "N. Jungarrayi", "O. Matsumoto", "L. Mununggurr", "H. Tjapaltjarri", "B. Wunungmurra", "J. Kurosawa", "M. Jakamarra", "F. Dhurrkay", "P. Tjungurrayi", "E. Matsumoto", "R. Kngwarreye", "I. Goto"]) },
{ code: "VER", name: "The Verdanie", skill: 75, style: "gegenpress", formation: "4-3-3", strategy: { dribbling: 1, creativity: 1, setPieces: 1, timeWasting: -1, possLost: 1, possWon: 1, gkDist: -1, pressingLOE: 2, defLine: 1, dlBehavior: 1 }, squad: buildSquad("4-3-3", ["J. Duplessie", "M. St. Laurent", "C. Beaubari", "J. Montecard", "M. Pelletier", "C. Roy", "E. Floranco", "M. Dubois", "E. Caracciolo", "L. Kuzumaki", "G. Belkacem", "T. Breville", "S. Morand", "P. Rousseau", "L. Vacherot", "G. Alexandre"]) },
{ code: "SEL", name: "Selmira", skill: 74, style: "counterattack", formation: "4-1-4-1", strategy: { passingDir: 1, chanceCreation: 1, dribbling: 1, creativity: 1, setPieces: 1, possLost: 1, possWon: 1, pressingLOE: 1, tackling: 1 }, squad: buildSquad("4-1-4-1", ["A. Aydın", "T. Kenaanoğlu", "E. Polat", "S. Sayda", "M. Doğan", "V. Surlu", "Y. Koç", "C. Kartaca", "O. Çetin", "B. Balyoz", "H. Şen", "D. Asur", "K. Bulut", "I. Fenik", "F. Kaplan", "Z. Tarık"]) },
{ code: "END", name: "El Endamo", skill: 74, style: "tikitaka", formation: "4-1-2-1-2", strategy: { approachPlay: -1, passingDir: -1, chanceCreation: -1, creativity: 1, possLost: -1, possWon: -1, gkDist: -1, tackling: -1 }, squad: buildSquad("4-1-2-1-2", ["L. Giménez", "E. Choque", "M. Colantonio", "J. Vargas", "T. Baravalle", "S. Condori", "F. Romero", "V. Mamani", "N. Pignatiello", "A. Flores", "D. Cingolani", "C. Huanca", "P. González", "R. Arancibia", "G. Chiarini", "I. Quispe"]) },
{ code: "CAL", name: "Calveria", skill: 74, style: "balanced", formation: "4-4-2", strategy: { passingDir: 1, creativity: -1, possLost: -1, tackling: 1 }, squad: buildSquad("4-4-2", ["J. Miller", "T. Yazzie", "E. Harrison", "M. Tsosie", "C. Caldwell", "A. Begay", "W. Gallagher", "D. Benally", "K. Nakai", "L. Nez", "H. Peshlakai", "P. Chee", "N. Jennings", "S. Davis", "V. Brooks", "R. Preston"]) },
{ code: "TWA", name: "West Aphirica", skill: 73, style: "gegenpress", formation: "4-3-3", strategy: { approachPlay: 1, passingDir: 1, dribbling: 1, creativity: -1, setPieces: 1, possLost: -1, possWon: 1, gkDist: 1, dlBehavior: -1, tackling: 1 }, squad: buildSquad("4-3-3", ["D. Ndiaye", "A. Goudiaby", "K. Sow", "O. Badiane", "M. Gueye", "T. Bassène", "B. Fall", "R. Mbengue", "C. Jatta", "S. Bojang", "F. Sané", "P. Sarr", "L. Ndour", "I. Dansoko", "N. Diallo", "G. Bodian"]) },
{ code: "PON", name: "Ponurvia", skill: 73, style: "gegenpress", formation: "4-3-3", strategy: { approachPlay: 1, chanceCreation: 1, dribbling: -1, creativity: 1, setPieces: 1, timeWasting: -1, possLost: 1, possWon: -1, pressingLOE: 2, dlBehavior: 2, tackling: -1 }, squad: buildSquad("4-3-3", ["M. Mollenhauer", "J. Wanamaker", "L. Bopp", "T. Zartmann", "E. Snyder", "D. Fassbender", "C. Neitzel", "A. Rittenhouse", "S. Stracke", "W. Giesel", "R. Schlösser", "K. Eckert", "N. Custer", "P. Hoffmeister", "H. Kinkeldey", "V. Scherer"]) },
{ code: "GEL", name: "Gelnburg", skill: 73, style: "wingplay", formation: "4-3-3", strategy: { approachPlay: 1, dribbling: 1, possWon: 1, tackling: -1 }, squad: buildSquad("4-3-3", ["A. Mueller", "F. Falkenberg", "K. Weber", "U. Himmelreich", "H. Wagner", "M. Eschenbach", "P. Becker", "J. Nachtigall", "V. Schmidt", "O. Morgenstern", "E. Hoffmann", "S. Kesselring", "C. Fischer", "D. Waldschmidt", "R. Meyer", "A. Silberstein"]) },
{ code: "EGC", name: "Golden Coast", skill: 73, style: "gegenpress", formation: "3-4-3", strategy: { approachPlay: 1, dribbling: 1, creativity: 1, timeWasting: -1, possLost: 1, possWon: 1, pressingLOE: 2, defLine: 1, dlBehavior: 1, tackling: 1 }, squad: buildSquad("3-4-3", ["D. Acheampong", "C. Nwachukwu", "O. Ouédraogo", "O. Diomandé", "S. Hountondji", "E. Akakpo", "O. Olamilekan", "I. Tapsoba", "B. Gbohouo", "F. Fassinou", "A. Boakye", "M. Ilboudo", "D. Chukwumah", "K. Kossoko", "N. Owusu", "G. Guikahué"]) },
{ code: "GOT", name: "Gothidonia", skill: 70, style: "balanced", formation: "4-3-3", strategy: { creativity: -1, setPieces: 1, possLost: -1, tackling: 1 }, squad: buildSquad("4-3-3", ["P. Nowak", "K. Niezgoda", "M. Kowalski", "B. Jastrzębski", "J. Wiśniewski", "T. Dziedzic", "S. Wójcik", "R. Gołębiowski", "A. Kaczmarek", "Z. Krzyżanowski", "G. Brzęczyszczykiewicz", "W. Wilczyński", "K. Szymański", "M. Czarnecki", "J. Kamiński", "T. Żelechowski"]) },
{ code: "SID", name: "Sidanya", skill: 69, style: "balanced", formation: "4-2-3-1", strategy: { approachPlay: 1, possWon: 1 }, squad: buildSquad("4-2-3-1", ["O. Shevchenko", "V. Nalyvaiko", "I. Kovalenko", "Y. Kryvonis", "N. Melnyk", "M. Holoborodko", "T. Bondarenko", "D. Perebyinis", "A. Tkachenko", "K. Vernydub", "S. Boyko", "B. Skoropadsky", "O. Kravchenko", "P. Dovzhenko", "I. Moroz", "L. Chornovil"]) },
{ code: "GUA", name: "Guandong", skill: 69, style: "tikitaka", formation: "3-4-1-2", strategy: { approachPlay: -1, passingDir: -1, dribbling: -1, creativity: -1, possLost: 1, possWon: -1, gkDist: -1, pressingLOE: 1, defLine: 1, dlBehavior: 1, tackling: -1 }, squad: buildSquad("3-4-1-2", ["Z. Wang", "X. Qiao", "Y. Li", "H. Kong", "Q. Zhang", "B. Yan", "W. Zhao", "F. Ji", "L. Hao", "C. Pei", "G. Sun", "T. Meng", "S. Guo", "J. Chai", "Y. Ma", "D. Jia"]) },
{ code: "VKT", name: "Kemet", skill: 68, style: "balanced", formation: "4-2-3-1", strategy: { creativity: -1, possLost: -1, possWon: 1, dlBehavior: -1, tackling: -1 }, squad: buildSquad("4-2-3-1", ["B. Shenouda", "G. Salvago", "R. Makram", "L. Moscatelli", "P. Tawadros", "N. Rossano", "Y. Ghattas", "F. Noseda", "M. Mina", "V. Piromalli", "S. Doss", "M. Loria", "T. Bishoy", "E. Zanon", "W. Fakhry", "C. Baliano"]) },
{ code: "VAR", name: "Varahmehr", skill: 67, style: "wingplay", formation: "4-3-3", strategy: { approachPlay: 1, passingDir: 1, dribbling: 1, timeWasting: -1, possLost: -1, possWon: 1, gkDist: 1, dlBehavior: -1, tackling: 1 }, squad: buildSquad("4-3-3", ["V. Lorestani", "E. Dehghan", "A. Danesh", "P. Tahmasb", "T. Hayaii", "R. Khalili", "M. Sahat", "S. Mehrian", "A. Mahdavi", "S. Shakibaii", "P. Nazeri", "C. Nassirian", "E. Rastkar", "M. Shahi", "S. Bozorgi", "K. Rezghi"]) },
{ code: "SGD", name: "Seignid", skill: 67, style: "balanced", formation: "4-4-2", strategy: { dribbling: 1, possLost: -1, possWon: 1, tackling: -1 }, squad: buildSquad("4-4-2", ["R. Agbayani", "T. Batumbakal", "N. Catacutan", "L. Dimayuga", "S. Gatmaitan", "H. Halili", "K. Ilagan", "P. Kalaw", "M. Liwanag", "J. Macaraeg", "C. Nacpil", "F. Panganiban", "V. Salonga", "A. Tapang", "E. Umali", "D. Yabut"]) },
{ code: "GIA", name: "Giathka", skill: 67, style: "counterattack", formation: "4-2-3-1", strategy: { approachPlay: 1, passingDir: 1, chanceCreation: -1, dribbling: -1, setPieces: 1, possLost: -1, possWon: 1, gkDist: 1, dlBehavior: -1, tackling: 1 }, squad: buildSquad("4-2-3-1", ["S. Volkov", "R. Stepanov", "D. Belov", "M. Fedorov", "A. Orlov", "U. Yusupov", "N. Lebedev", "B. Vinogradov", "I. Morozov", "T. Rahimov", "V. Polyakov", "O. Makarov", "K. Kozlov", "Y. Bogdanov", "P. Egorov", "G. Voronov"]) },
{ code: "FUR", name: "Furan", skill: 67, style: "counterattack", formation: "4-1-4-1", strategy: { approachPlay: 1, passingDir: 1, creativity: -1, possLost: -1, possWon: 1, gkDist: 1, defLine: -1, dlBehavior: -1, tackling: -1 }, squad: buildSquad("4-1-4-1", ["Y. Chen", "L. Wu", "J. Shen", "X. Qian", "M. Xiong", "H. Peng", "F. Lu", "Q. Zhu", "T. Gu", "S. Huang", "W. Mao", "R. Deng", "B. Ye", "Z. Fang", "K. Tan", "N. Jiang"]) },
{ code: "POL", name: "Polabiny", skill: 66, style: "counterattack", formation: "4-4-2", strategy: { approachPlay: 1, passingDir: 1, creativity: -1, setPieces: 1, possLost: -1, possWon: 1, gkDist: 1, defLine: -1, dlBehavior: -1, tackling: 1 }, squad: buildSquad("4-4-2", ["J. Svoboda", "M. Skočdopole", "L. Kučera", "P. Kratochvíl", "D. Tóth", "V. Zlatohlavý", "S. Veselý", "R. Vohánka", "T. Horváth", "A. Nejezchleb", "K. Černý", "E. Valach", "F. Novotný", "Z. Bezruč", "O. Varga", "H. Pospíšil"]) },
{ code: "LIV", name: "Livonia", skill: 66, style: "counterattack", formation: "4-1-4-1", strategy: { passingDir: 1, creativity: -1, setPieces: 1, possLost: -1, possWon: 1, gkDist: 1, defLine: -1, dlBehavior: -1, tackling: 1 }, squad: buildSquad("4-1-4-1", ["A. Berg", "H. von Buxhoeveden", "M. Müller", "E. Tiesenhausen", "J. Hermann", "R. von Ungern", "L. Becker", "W. Wrangell", "F. Meyer", "O. Manteuffel", "P. Schmidt", "K. Stackelberg", "D. Hoffmann", "G. Vietinghoff", "S. Schultz", "V. Krusenstern"]) }
];
const PRESET_AVIUM = [
{ code: "TES", name: "Saint Testudera", skill: 87, style: "tikitaka", formation: "4-3-3", strategy: { approachPlay: -1, passingDir: -2, chanceCreation: -1, dribbling: -1, creativity: 1, timeWasting: -1, possLost: 1, possWon: -1, gkDist: -1, pressingLOE: 2, defLine: 2, dlBehavior: 2, tackling: -1 }, squad: buildSquad("4-3-3", ["X. Cienfuegos", "V. Peixoto", "I. Urrutia", "O. Montagut", "R. Alvarenga", "G. Valbuena", "Y. Bengoetxea", "T. Candeias", "P. Puigcorbé", "M. Salcedo", "B. Figueira", "U. Izagirre", "D. Quintana", "J. Xirau", "L. Escudero", "N. Gouveia"]) },
{ code: "NCH", name: "Nichirin", skill: 86, style: "wingplay", formation: "4-4-2", strategy: { passingDir: -1, chanceCreation: -1, dribbling: 1, creativity: 1, possLost: -1, possWon: 1, gkDist: -1, pressingLOE: 1, dlBehavior: -1, tackling: -1 }, squad: buildSquad("4-4-2", ["K. Ouyang", "S. Segawa", "D. Takanashi", "G. Fija", "A. Nagumo", "T. Bashira", "T. Mikado", "M. Kishima", "L. Higashiyama", "G. Erdene", "S. Itoshi", "E. Sato", "G. Nishigawa", "K. Torigoe", "W. Kon", "H. Morimoto"]) },
...
{ code: "POL", name: "Polabiny", skill: 66, style: "counterattack", formation: "4-4-2", strategy: { approachPlay: 1, passingDir: 1, creativity: -1, setPieces: 1, possLost: -1, possWon: 1, gkDist: 1, defLine: -1, dlBehavior: -1, tackling: 1 }, squad: buildSquad("4-4-2", ["J. Svoboda", "M. Skočdopole", "L. Kučera", "P. Kratochvíl", "D. Tóth", "V. Zlatohlavý", "S. Veselý", "R. Vohánka", "T. Horváth", "A. Nejezchleb", "K. Černý", "E. Valach", "F. Novotný", "Z. Bezruč", "O. Varga", "H. Pospíšil"]) },
{ code: "LIV", name: "Livonia", skill: 66, style: "counterattack", formation: "4-1-4-1", strategy: { passingDir: 1, creativity: -1, setPieces: 1, possLost: -1, possWon: 1, gkDist: 1, defLine: -1, dlBehavior: -1, tackling: 1 }, squad: buildSquad("4-1-4-1", ["A. Berg", "H. von Buxhoeveden", "M. Müller", "E. Tiesenhausen", "J. Hermann", "R. von Ungern", "L. Becker", "W. Wrangell", "F. Meyer", "O. Manteuffel", "P. Schmidt", "K. Stackelberg", "D. Hoffmann", "G. Vietinghoff", "S. Schultz", "V. Krusenstern"]) },
{ code: "CAH", name: "Cahaya", skill: 66, style: "wingplay", formation: "3-4-3", strategy: { approachPlay: 1, dribbling: 1, creativity: 1, possLost: 1, possWon: 1, pressingLOE: 1, tackling: -1 }, squad: buildSquad("3-4-3", ["R. Wijaya", "L. Kitingan", "T. Setiawan", "P. Jugah", "A. Ginting", "S. Madius", "W. Wibowo", "E. Bansa", "M. Djelantik", "K. Kurup", "D. Siregar", "G. Parengkuan", "H. Mutang", "V. Sastrowardoyo", "N. Panggabean", "C. Kulleh"]) },
{ code: "SHI", name: "Shivon", skill: 65, style: "counterattack", formation: "4-2-3-1", strategy: { approachPlay: 1, creativity: -1, possLost: -1, possWon: 1, defLine: -1, dlBehavior: -1, tackling: -1 }, squad: buildSquad("4-2-3-1", ["Y. Cohen", "A. Bar-Lev", "T. Mizrahi", "N. Tzur", "O. Levi", "S. Even-Khen", "E. Peretz", "M. Shaked", "R. Biton", "D. Alon", "G. Dahan", "I. Avni", "L. Agam", "Z. Peled", "H. Friedman", "B. Ben-Ami"]) },
{ code: "AST", name: "East Astriya", skill: 65, style: "balanced", formation: "4-4-2", strategy: { creativity: -1, possLost: -1 }, squad: buildSquad("4-4-2", ["N. Papadopoulos", "K. Paleologos", "A. Georgiou", "S. Lykoudis", "V. Nikolaou", "E. Mavromatis", "P. Karagiannis", "T. Zervas", "D. Vlahos", "M. Galanis", "I. Christodoulou", "Y. Athanasiadis", "G. Grivas", "O. Katsaros", "X. Samaras", "C. Angelopoulos"]) },
{ code: "ATK", name: "Tonkin", skill: 63, style: "counterattack", formation: "4-1-4-1", strategy: { approachPlay: 1, passingDir: 1, creativity: -1, possLost: -1, possWon: 1, gkDist: 1, defLine: -1, dlBehavior: -1, tackling: -1 }, squad: buildSquad("4-1-4-1", ["J. Nguyen", "M. Ton That", "P. Le", "C. Khuat", "D. Tran", "F. Doan", "L. Vu", "A. Thach", "S. Pham", "E. Trieu", "V. Ngo", "R. Mach", "G. Bui", "H. Luong", "T. Dang", "B. Quach"]) },
{ code: "TTO", name: "Terra Oeste", skill: 62, style: "wingplay", formation: "4-3-3", strategy: { approachPlay: 1, dribbling: 1, possWon: 1, tackling: -1 }, squad: buildSquad("4-3-3", ["A. Martínez", "R. Ixcoy", "C. Hernández", "J. Arzu", "M. López", "D. Chinchilla", "P. García", "E. Caal", "L. Mejía", "S. Balam", "V. Morales", "K. Bodden", "T. Aguilar", "F. Cotí", "G. Castillo", "H. Ugalde"]) },
{ code: "THO", name: "The Thorne", skill: 62, style: "balanced", formation: "4-3-3", strategy: { creativity: 1, possWon: 1, tackling: -1 }, squad: buildSquad("4-3-3", ["O. Popescu", "T. Zburătoru", "M. Ionescu", "C. Codreanu", "I. Radu", "V. Lăutaru", "D. Dumitrescu", "L. Bucur", "S. Stan", "E. Botezatu", "G. Stoica", "R. Fieraru", "N. Munteanu", "F. Porumbescu", "P. Gheorghiu", "O. Văduva"]) },
{ code: "PER", name: "Perovska", skill: 62, style: "counterattack", formation: "4-4-2", strategy: { approachPlay: 1, passingDir: 1, creativity: -1, possLost: -1, possWon: 1, gkDist: 1, defLine: -1, dlBehavior: -1, tackling: 1 }, squad: buildSquad("4-4-2", ["E. Karpov", "S. Andreev", "G. Nikitin", "O. Mamut", "L. Gusev", "K. Zaytsev", "R. Titov", "D. Kenzhebayev", "M. Kulikov", "A. Turghun", "F. Frolov", "V. Markov", "I. Baranov", "N. Shirokov", "T. Tarasov", "P. Denisov"]) },
{ code: "ASP", name: "South Pelagonia", skill: 62, style: "tikitaka", formation: "4-3-3", strategy: { approachPlay: -1, passingDir: -1, possLost: 1, possWon: -1, gkDist: -1, pressingLOE: 1, defLine: 1, tackling: -1 }, squad: buildSquad("4-3-3", ["J. Dlamini", "C. Buthelézi", "M. Ndlovu", "J. Mocoéna", "E. Khumalo", "V. Zoulou", "P. Modisé", "L. Du Phiri", "S. Chabalala", "R. Khouza", "R. Mbeki", "D. Sisoulou", "F. Hadebé", "G. Nhlapo-Marais", "H. Bhéngu", "O. Makhanya"]) },
{ code: "ANH", name: "Neuhollmar", skill: 62, style: "balanced", formation: "4-4-2", strategy: { passingDir: 1, possLost: -1, tackling: 1 }, squad: buildSquad("4-4-2", ["T. Schmidt", "J. Rangitāne", "K. Mueller", "F. Te Rangi", "R. Hoffmann", "H. Wihongi", "M. Becker", "A. von Haast", "W. Meyer", "E. Waititi", "P. Rata", "G. Tipene", "N. Wagner", "L. Ihimaera", "A. Dieffenbach", "O. Kereopa"]) },
{ code: "ABB", name: "Barbary", skill: 61, style: "gegenpress", formation: "3-4-3", strategy: { approachPlay: 1, chanceCreation: 1, dribbling: 1, timeWasting: -1, possLost: 1, possWon: 1, pressingLOE: 2, defLine: 1, dlBehavior: 1, tackling: 1 }, squad: buildSquad("3-4-3", ["H. Benali", "T. Djaballah", "S. Mansouri", "A. Aggoun", "M. Bensalem", "F. Kateb", "O. Rahmani", "C. Guerroudj", "K. Idir", "L. Meziane", "B. Hamraoui", "L. Renard", "K. Benfodil", "G. Fabre", "O. Mebarki", "A. Picard"]) },
{ code: "TBC", name: "Briacosta", skill: 60, style: "counterattack", formation: "4-1-4-1", strategy: { approachPlay: 1, creativity: -1, possLost: -1, possWon: 1, defLine: -1, dlBehavior: -1, tackling: -1 }, squad: buildSquad("4-1-4-1", ["Y. Benali", "M. El Andaloussi", "A. Berrada", "H. Medina", "B. Chraibi", "T. Amrani", "S. Torres", "N. Mansouri", "O. El Fassi", "K. Alami", "I. Morón", "Y. Zeroual", "B. Oufkir", "I. Messaoudi", "T. Benjumeda", "S. Lahlou"]) },
{ code: "MOR", name: "Morozia", skill: 60, style: "counterattack", formation: "5-3-2", strategy: { passingDir: 1, creativity: -1, setPieces: 1, timeWasting: 1, possLost: -1, possWon: 1, gkDist: 1, pressingLOE: -1, defLine: -1, dlBehavior: -1, tackling: 1 }, squad: buildSquad("5-3-2", ["A. Ahmaogak", "M. Makaroff", "P. Ipalook", "I. Gromoff", "E. Nageak", "S. Krukoff", "K. Kadashan", "V. Tarakanoff", "N. Oyagak", "D. Lestenkof", "L. Kignak", "T. Bereskin", "R. Naneng", "Y. Galaktionoff", "F. Ayagalria", "M. Katchatag"]) },
{ code: "AWB", name: "West Bangala", skill: 60, style: "balanced", formation: "4-4-2", strategy: { possLost: -1, tackling: -1 }, squad: buildSquad("4-4-2", ["K. Rahman", "L. Chowdhury", "E. Islam", "J. Hossain", "C. Ahmed", "M. Hasan", "F. Miah", "D. Sikder", "V. Talukder", "P. Bhuiyan", "R. Khandaker", "S. Majumder", "N. Haque", "G. Das", "T. Barua", "I. Kazi"]) },
{ code: "EAK", name: "Arakanland", skill: 58, style: "counterattack", formation: "4-1-4-1", strategy: { approachPlay: 1, passingDir: 1, creativity: -1, possLost: -1, possWon: 1, gkDist: 1, defLine: -1, dlBehavior: -1, tackling: -1 }, squad: buildSquad("4-1-4-1", ["K. Hlaing", "N. Thant", "A. Naing", "M. Kyaw", "W. Phyo", "T. Myo", "Z. Zaw", "H. Htun", "S. Htoo", "L. Kham", "O. Pemberton", "P. Thet", "B. Mra", "E. Shwe", "Y. Nge", "R. Nyunt"]) },
{ code: "ARU", name: "Arunya", skill: 58, style: "balanced", formation: "4-4-2", strategy: { possLost: -1, tackling: -1 }, squad: buildSquad("4-4-2", ["T. Annamalai", "K. Gunawardena", "S. Thiruvengadam", "V. Arulampalam", "M. Shivaswamy", "A. Dissanayake", "R. Unnithan", "O. Venkataraman", "B. Garlett", "D. Thuraisingam", "N. Madhavan", "G. Hegde", "H. Amarasinghe", "J. Krishnamurthy", "E. Arunachalam", "W. Bropho"]) },
{ code: "AEK", name: "East Kaukasos", skill: 58, style: "counterattack", formation: "4-4-2", strategy: { approachPlay: 1, passingDir: 1, creativity: -1, possLost: -1, possWon: 1, gkDist: 1, defLine: -1, dlBehavior: -1, tackling: 1 }, squad: buildSquad("4-4-2", ["N. Nadaraia", "A. Aghababyan", "T. Bakhshiyev", "O. Tvalchrelidze", "V. Manukyan", "M. Karimli", "D. Sulaberidze", "S. Ohanian", "R. Verdiyev", "B. Garnier", "C. Chalikyan", "D. Khutsishvili", "E. Piriyev", "V. Bedrossian", "Y. Mercier", "Z. Tvildiani"]) },
{ code: "ADV", name: "Divia", skill: 58, style: "balanced", formation: "4-4-2", strategy: { setPieces: 1, possLost: -1 }, squad: buildSquad("4-4-2", ["K. Janabi", "A. Doski", "T. Mutairi", "O. Bayati", "M. Nerweyi", "S. Azzawi", "R. Enezi", "B. Khafaji", "V. Kohlmann", "R. Barzani", "P. Rekabi", "H. Rashidi", "J. Barwari", "G. Musawi", "W. Pfeiffer", "X. Hawrami"]) },
{ code: "TAC", name: "Testuderan Acadia", skill: 57, style: "balanced", formation: "4-4-2", strategy: { passingDir: 1, possLost: -1, tackling: 1 }, squad: buildSquad("4-4-2", ["A. Debassige", "F. Varela", "G. Wemigwans", "D. Obomsawin", "M. Herrera", "K. Nottaway", "E. Wagamese", "J. Fonseca", "C. Papatie", "N. Nadjiwon", "B. Manitowabi", "P. Pedrosa", "H. Tenasco", "O. Panadis", "L. Kakepetum", "I. Wawanolet"]) },
{ code: "NHO", name: "Hōrai", skill: 56, style: "balanced", formation: "4-4-2", strategy: { approachPlay: 1, passingDir: 1, dribbling: 1, creativity: 1, setPieces: 1, possLost: 1, possWon: 1, gkDist: 1, pressingLOE: 1, dlBehavior: -1 }, squad: buildSquad("4-4-2", ["I. Tarafdar", "B. Larma", "P. Chakma", "R. Mridha", "A. Tripura", "M. Sangma", "S. Murmu", "W. Naqvi", "N. Fujikawa", "K. Nagase", "T. Howlader", "E. Patwary", "O. Bepari", "D. Pramanik", "Z. Soren", "G. Marak"]) },
{ code: "ENA", name: "North Auritania", skill: 56, style: "wingplay", formation: "3-4-3", strategy: { approachPlay: 1, dribbling: 1, creativity: 1, timeWasting: -1, possLost: 1, possWon: 1, pressingLOE: 1, tackling: -1 }, squad: buildSquad("3-4-3", ["A. Potiguara", "T. Jaguaribe", "U. Tupinambá", "J. Tabajara", "M. Jurema", "G. Acauã", "I. Kariri", "N. Canindé", "Y. Tremembé", "B. Ibiapina", "R. Pankararu", "E. Pirambu", "W. Fenwick", "C. Dunmore", "Z. Xukuru", "O. Itapicuru"]) },
{ code: "AXE", name: "Axerfreditenshin", skill: 56, style: "balanced", formation: "4-4-2", strategy: { approachPlay: 1, passingDir: 1, possLost: -1, possWon: 1, gkDist: 1, tackling: 1 }, squad: buildSquad("4-4-2", ["B. Bat-Erdene", "Y. Ma", "D. Dorzhiev", "N. Chimeddorj", "H. Ha", "G. Badmaev", "T. Gantulga", "I. Mu", "R. Tsydypov", "E. Tsendbaatar", "K. Ding", "S. Munkoev", "A. Lkhagvadorj", "M. Bai", "O. Gombojav", "J. Na"]) },
{ code: "AKG", name: "Kogelland", skill: 55, style: "tikitaka", formation: "4-4-2", strategy: { approachPlay: -1, passingDir: -1, creativity: -1, possLost: 1, possWon: -1, gkDist: -1, pressingLOE: 1, tackling: -1 }, squad: buildSquad("4-4-2", ["A. Calfuqueo", "D. Brunner", "N. Ñanculef", "G. Verhoeven", "C. Cayupán", "L. Painemal", "W. Sayhueque", "P. Hoekstra", "M. Tripailaf", "O. Inacayal", "I. Loncón", "H. Zimmermann", "K. Quidel", "T. Quilaqueo", "F. Huenchullán", "E. Panguilef"]) },
{ code: "AED", name: "Dämmerung Islands", skill: 55, style: "balanced", formation: "4-3-3", strategy: {}, squad: buildSquad("4-3-3", ["K. Kanakaole", "G. Van Leeuwen", "N. Kealoha", "A. Steiner", "I. Makoa", "U. Piipiilani", "P. Nainoa", "D. Mulder", "H. Kahananui", "E. Pokipala", "L. Kekoa", "W. Kooijman", "M. Kinimaka", "F. Mahoe", "O. Naone", "J. Kupihea"]) },
{ code: "ACS", name: "Côte de Saumon", skill: 54, style: "gegenpress", formation: "4-3-3", strategy: { approachPlay: 1, dribbling: 1, timeWasting: -1, possLost: 1, possWon: 1, pressingLOE: 2, defLine: 1, dlBehavior: 1, tackling: 1 }, squad: buildSquad("4-3-3", ["I. Galadima", "A. Dikko", "B. Dalori", "M. Lefèvre", "S. Turaki", "N. Maina", "O. Jalo", "E. Fontaine", "Y. Dattijo", "K. Mainasara", "G. Magaji", "T. Tafida", "H. Barry", "R. Ingawa", "U. Yakasai", "L. Zanna"]) },
{ code: "GUP", name: "Uj-Pannonia", skill: 52, style: "balanced", formation: "4-4-2", strategy: { possLost: -1, tackling: -1 }, squad: buildSquad("4-4-2", ["P. Hazarika", "K. Basumatary", "G. Molnár", "R. Gogoi", "S. Narzary", "L. Balogh", "M. Payeng", "H. Saikia", "T. Lakatos", "A. Bhuyan", "D. Teron", "F. Papp", "N. Konwar", "J. Brahma", "U. Mahanta", "B. Rajkhowa"]) },
{ code: "ENR", name: "Noradia", skill: 52, style: "balanced", formation: "4-4-2", strategy: { possLost: -1, tackling: -1 }, squad: buildSquad("4-4-2", ["B. Mohapatra", "S. Markam", "F. Tirkey", "R. Cavendish", "K. Rath", "G. Hansda", "A. Bamford", "L. Hembrom", "D. Soren", "N. Senapati", "M. Patnaik", "P. Toppo", "J. Lakra", "T. Khuntia", "H. Netam", "C. Forsyth"]) },
{ code: "EPT", name: "Pontus", skill: 51, style: "counterattack", formation: "4-1-4-1", strategy: { passingDir: 1, creativity: -1, possLost: -1, possWon: 1, gkDist: 1, defLine: -1, dlBehavior: -1, tackling: 1 }, squad: buildSquad("4-1-4-1", ["A. Botan", "L. Minasian", "K. Herki", "E. Ridgeway", "M. Jaf", "B. Odisho", "G. Garabedian", "S. Bedirkhan", "D. Soran", "V. Mouradian", "H. Hawthorn", "N. Zaia", "W. Mirza", "Z. Vartanian", "T. Sefton", "R. Berwari"]) },
{ code: "SSA", name: "Southeast Aphirica", skill: 48, style: "balanced", formation: "4-4-2", strategy: { passingDir: 1, possLost: -1, gkDist: 1 }, squad: buildSquad("4-4-2", ["D. Akol", "T. Tikima", "B. Chuol", "M. Shapira", "A. Madut", "G. Hoth", "W. Lual", "U. Katz", "N. Thon", "F. Gbaduma", "P. Gatluak", "Y. Toledano", "R. Majok", "J. Gony", "O. Azoulay", "L. Nhial"]) },
{ code: "ANB", name: "Napolyon Bonparterre Islands", skill: 48, style: "wingplay", formation: "3-4-3", strategy: { approachPlay: 1, dribbling: 1, creativity: 1, possWon: 1, tackling: -1 }, squad: buildSquad("3-4-3", ["J. Gonelevu", "M. Singh", "S. Seruvakula", "A. Moreau", "N. Tikoisuva", "I. Titifanue", "E. Leweniqila", "T. Thibault", "V. Latianara", "R. Narayan", "K. Rigamoto", "Y. Lacroix", "P. Naivalu", "W. Ravuiwasa", "D. Koroi", "U. Veitayaki"]) },
{ code: "AKN", name: "Kienam", skill: 44, style: "counterattack", formation: "4-1-4-1", strategy: { passingDir: 1, creativity: -1, possLost: -1, possWon: 1, gkDist: 1, pressingLOE: -1, defLine: -1, dlBehavior: -1, tackling: 1 }, squad: buildSquad("4-1-4-1", ["N. Tikana", "A. Kaviu", "V. To Ngala", "F. Steiner", "T. Turuk", "G. Vunairoto", "S. Vatom", "J. Navrátil", "M. Tamate", "O. Berger", "R. Simet", "L. Růžička", "D. Vunamami", "P. Pondros", "B. To Warai", "W. Nonga"]) },
{ code: "ENC", name: "New Celyddon", skill: 43, style: "wingplay", formation: "3-4-3", strategy: { approachPlay: 1, dribbling: 1, creativity: 1, possWon: 1, tackling: -1 }, squad: buildSquad("3-4-3", ["W. Bwemara", "S. Lagivaka", "K. Hnamano", "D. MacKenzie", "N. Naisseline", "F. Vailala", "P. Kabar", "R. Sutherland", "M. Löpwi", "T. Peato", "J. Paoume", "A. Campbell", "H. Tanéouya", "G. Waia", "E. Tein", "Y. Yaka"]) },
{ code: "KKM", name: "Kullanmaan", skill: 42, style: "balanced", formation: "4-4-2", strategy: { possLost: -1 }, squad: buildSquad("4-4-2", ["O. Hætta", "E. Sateräkki", "S. Krusinen", "B. Tuuliparänen", "J. Urujärven", "T. Kuutemben", "P. Amarainen", "L. Vesijärven", "F. Kulanen", "T. Poule", "V. Turkunen", "T. Bonkonen", "S. Grigoroff", "E. Guovžžanen", "O. Sieidala", "L. Hitalainen"]) },
{ code: "AGN", name: "Gonenite Islands", skill: 42, style: "balanced", formation: "4-4-2", strategy: { possLost: -1 }, squad: buildSquad("4-4-2", ["J. Nanau", "T. Meka", "H. Kabutaulaka", "E. Kessler", "M. Tanangada", "B. Taupongi", "K. Hartmann", "N. Suifua", "A. Taloikwao", "W. Steinberg", "P. Iroga", "G. Wanefiori", "S. Kiloe", "F. Boseto", "R. Teika", "O. Sisiolo"]) },
{ code: "VAN", name: "Aphirica del Nord", skill: 41, style: "counterattack", formation: "5-3-2", strategy: { passingDir: 1, dribbling: -1, creativity: -1, setPieces: 1, possLost: -1, possWon: 1, gkDist: 1, defLine: -1, dlBehavior: -1, tackling: 1 }, squad: buildSquad("5-3-2", ["C. Gbanou", "M. Ngaradoumbé", "E. Amato", "R. Yakété", "K. Kobanda", "G. Mancini", "P. Guébré", "O. Borkono", "N. Nakombo", "A. Maïna", "B. Wongo", "S. Sorrentino", "T. Mandaba", "I. Gali", "F. Mobele", "L. Yangongo"]) },
{ code: "AAD", name: "Andam Islands", skill: 39, style: "counterattack", formation: "4-3-2-1", strategy: { passingDir: 1, creativity: -1, timeWasting: 1, possLost: -1, possWon: 1, gkDist: 1, pressingLOE: -1, defLine: -1, dlBehavior: -1, tackling: 1 }, squad: buildSquad("4-3-2-1", ["N. Patchila", "S. Htoo", "E. Totanange", "M. Beneš", "P. Atong", "G. Sedláček", "B. Ponge", "I. Nanlong", "D. Paw", "J. Fischer", "K. Chari", "C. Melong", "T. Moo", "R. Zelenka", "F. Telong", "A. Enam"]) },
{ code: "ASG", name: "Sankt Gerold Island", skill: 38, style: "counterattack", formation: "4-3-2-1", strategy: { passingDir: 1, creativity: -1, timeWasting: 1, possLost: -1, possWon: 1, gkDist: 1, pressingLOE: -1, defLine: -1, dlBehavior: -1, tackling: 1 }, squad: buildSquad("4-3-2-1", ["H. Kogoya", "S. Rumbekwan", "W. Pakage", "J. Brouwer", "I. Wetipo", "A. Klafle", "N. Wanimbo", "P. Van Dam", "E. Desap", "Y. Tekege", "D. Imbiri", "F. Hendriks", "O. Biwar", "G. Mandosir", "B. Wandik", "M. Mote"]) },
{ code: "KFK", name: "Frederikka Islands", skill: 28, style: "wingplay", formation: "4-1-2-1-2", strategy: { approachPlay: 1, passingDir: 1, chanceCreation: -1, dribbling: 1, creativity: 1, setPieces: 1, timeWasting: -1, possLost: -1, possWon: 1, gkDist: 1, defLine: -1, dlBehavior: -1, tackling: -1 }, squad: buildSquad("4-1-2-1-2", ["A. Raivo", "P. Shomponen", "T. Pacaka", "N. Apngan", "E. Samāyan", "N. Laranyal", "V. Chōna", "R. Ātlaköneinen", "P. Suursaaren", "D. Lâchūaton", "O. Marvinen", "J. Hosea", "A. Rani", "I. Hatamaaen", "T. Ranghonen", "E. Fāpen"]) }
];
const PRESET_EUR = [
...
export default function App() {
  ...
  const [teams, setTeams] = useState(() => PRESET_DEF.map(t => ({...t, strategy: {...(t.strategy||{})}, squad: t.squad ? t.squad.map(p => ({...p})) : null})));
      ...
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: teamsOpen ? 8 : 16, minHeight: 32 }}>
          ...
          <div style={{ display: "flex", gap: 6 }}>
            {teamsOpen && <select onChange={e => { if (e.target.value === "def") loadPreset(PRESET_DEF); else if (e.target.value === "avium") loadPreset(PRESET_AVIUM); else if (e.target.value === "eur") loadPreset(PRESET_EUR); e.target.value = ""; }} style={{ ...addBtn, padding: "4px 8px", fontSize: 10, color: "#3d5343", background: "transparent", cursor: "pointer" }}><option value="" hidden>☰ Preset</option><option value="def">Avium (32)</option><option value="avium">Avium (Full)</option><option value="eur">European (46)</option></select>}
              ...
              return (
                <div id="bracket-export" style={{ background: "#0f1310", border: "1px solid #1a221a", borderRadius: 10, padding: 16, marginBottom: 12, overflowX: "auto" }}>
                  <div style={{ display: "flex", alignItems: "stretch", gap: 0, minWidth: "fit-content" }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center", height: actualH, flexShrink: 0, gap: 8, marginTop: hdrH }}>
                      <div style={{ fontSize: 8, color: "#c9a84c", textAlign: "center", letterSpacing: 1, fontWeight: 600 }}>FINAL</div>
                      {miniCard(tKO.rounds[nR-1].matches[0], nR-1, 0, 0)}
                      {tKO.thirdPlace && <>
                        <div style={{ fontSize: 8, color: "#d08770", textAlign: "center", letterSpacing: 1, marginTop: 12, fontWeight: 600 }}>3RD PLACE</div>
