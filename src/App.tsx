      ...
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: teamsOpen ? 8 : 16, minHeight: 32 }}>
          ...
          <div style={{ display: "flex", gap: 6 }}>
            {teamsOpen && <select onChange={e => { if (e.target.value === "avium") loadPreset(PRESET_AVIUM); else if (e.target.value === "eur") loadPreset(PRESET_EUR); e.target.value = ""; }} style={{ ...addBtn, padding: "4px 8px", fontSize: 10, color: "#3d5343", background: "transparent", cursor: "pointer" }}><option value="" hidden>☰ Preset</option><option value="avium">Avium (62)</option><option value="eur">European (46)</option></select>}
