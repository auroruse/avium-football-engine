...
END	El Endamo	74	Tiki-Taka	4-1-2-1-2	Play Out of Defence	Shorter	Work Ball Into Box	No Instruction	Be More Expressive	No Instruction	Sometimes	Regroup	Hold Shape	Short	Standard	Standard	No Instruction	Stay On Feet	L. Giménez	E. Choque	M. Colantonio	J. Vargas	T. Baravalle	S. Condori	F. Romero	V. Mamani	N. Pignatiello	A. Flores	D. Cingolani	C. Huanca	P. González	R. Arancibia	G. Chiarini	I. Quispe
...
TWA	West Aphirica	73	Gegenpress	4-3-3	Pass Into Space	More Direct	No Instruction	Run At Defence	Be More Disciplined	Play for Set Pieces	Sometimes	Regroup	Counter	Long	Standard	Standard	Drop Off	Get Stuck In	D. Ndiaye	A. Goudiaby	K. Sow	O. Badiane	M. Gueye	T. Bassène	B. Fall	R. Mbengue	C. Jatta	S. Bojang	F. Sané	P. Sarr	L. Ndour	I. Dansoko	N. Diallo	G. Bodian
...
GEL	Gelnburg	73	Wing Play	4-3-3	Pass Into Space	Standard	No Instruction	Run At Defence	No Instruction	No Instruction	Sometimes	No Instruction	Counter	No Instruction	Standard	Standard	No Instruction	Stay On Feet	A. Mueller	F. Falkenberg	K. Weber	U. Himmelreich	H. Wagner	M. Eschenbach	P. Becker	J. Nachtigall	V. Schmidt	O. Morgenstern	E. Hoffmann	S. Kesselring	C. Fischer	D. Waldschmidt	R. Meyer	A. Silberstein
EGC	Golden Coast	73	Gegenpress	3-4-3	Pass Into Space	Standard	No Instruction	Run At Defence	Be More Expressive	No Instruction	Never	Counter-Press	Counter	No Instruction	Much Higher	Higher	Step Up	Get Stuck In	D. Acheampong	C. Nwachukwu	O. Ouédraogo	O. Diomandé	S. Hountondji	E. Akakpo	O. Olamilekan	I. Tapsoba	B. Gbohouo	F. Fassinou	A. Boakye	M. Ilboudo	D. Chukwumah	K. Kossoko	N. Owusu	G. Guikahué
GOT	Gothidonia	70	Balanced	4-3-3	No Instruction	Standard	No Instruction	No Instruction	Be More Disciplined	Play for Set Pieces	Sometimes	Regroup	No Instruction	No Instruction	Standard	Standard	No Instruction	Get Stuck In	P. Nowak	K. Niezgoda	M. Kowalski	B. Jastrzębski	J. Wiśniewski	T. Dziedzic	S. Wójcik	R. Gołębiowski	A. Kaczmarek	Z. Krzyżanowski	G. Brzęczyszczykiewicz	W. Wilczyński	K. Szymański	M. Czarnecki	J. Kamiński	T. Żelechowski
...
TTO	Terra Oeste	62	Wing Play	4-3-3	Pass Into Space	Standard	No Instruction	Run At Defence	No Instruction	No Instruction	Sometimes	No Instruction	Counter	No Instruction	Standard	Standard	No Instruction	Stay On Feet	A. Martínez	R. Ixcoy	C. Hernández	J. Arzu	M. López	D. Chinchilla	P. García	E. Caal	L. Mejía	S. Balam	V. Morales	K. Bodden	T. Aguilar	F. Cotí	G. Castillo	H. Ugalde
...
EAK	Arakanland	58	Counter	4-1-4-1	Pass Into Space	More Direct	No Instruction	No Instruction	Be More Disciplined	No Instruction	Sometimes	Regroup	Counter	Long	Standard	Lower	Drop Off	Stay On Feet	K. Hlaing	N. Thant	A. Naing	M. Kyaw	W. Phyo	T. Myo	Z. Zaw	H. Htun	S. Htoo	L. Kham	O. Pemberton	P. Thet	B. Mra	E. Shwe	Y. Nge	R. Nyunt
...
ENA	North Auritania	56	Wing Play	3-4-3	Pass Into Space	Standard	No Instruction	Run At Defence	Be More Expressive	No Instruction	Never	Counter-Press	Counter	No Instruction	Higher	Standard	No Instruction	Stay On Feet	A. Potiguara	T. Jaguaribe	U. Tupinambá	J. Tabajara	M. Jurema	G. Acauã	I. Kariri	N. Canindé	Y. Tremembé	B. Ibiapina	R. Pankararu	E. Pirambu	W. Fenwick	C. Dunmore	Z. Xukuru	O. Itapicuru
...
EPT	Pontus	51	Counter	4-1-4-1	No Instruction	More Direct	No Instruction	No Instruction	Be More Disciplined	No Instruction	Sometimes	Regroup	Counter	Long	Standard	Lower	Drop Off	Get Stuck In	A. Botan	L. Minasian	K. Herki	E. Ridgeway	M. Jaf	B. Odisho	G. Garabedian	S. Bedirkhan	D. Soran	V. Mouradian	H. Hawthorn	N. Zaia	W. Mirza	Z. Vartanian	T. Sefton	R. Berwari
      ...
      <div style={{ maxWidth: 900, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: teamsOpen ? 8 : 16, minHeight: 32 }}>
          ...
          <div style={{ display: "flex", gap: 6 }}>
            {teamsOpen && <select onChange={e => { if (e.target.value === "avium") loadPreset(PRESET_AVIUM); else if (e.target.value === "eur") loadPreset(PRESET_EUR); e.target.value = ""; }} style={{ ...addBtn, padding: "4px 8px", fontSize: 10, color: "#3d5343", background: "transparent", cursor: "pointer" }}><option value="" hidden>☰ Preset</option><option value="avium">Avium (69)</option><option value="eur">European (46)</option></select>}
